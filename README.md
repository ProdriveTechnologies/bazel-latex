...
BibLaTeX support is available by the use of biber. The necessary platform binary
will be obtained from SourceForge (which might cause fetching to take a while).
